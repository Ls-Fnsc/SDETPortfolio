...
import bug1Picture1 from '../../images/jira_bug1_1.png';
import bug1Picture2 from '../../images/jira_bug1_2.png';
...
export const CaseStudy = () => {
  return (
    <div className="caseStudyContainer">
        ...
        <Grid container spacing={4} columns={{ xs: 2, sm: 2, md: 8}}>
            <Grid item xs={2} sm={4} md={4} className="gridContainer">
                <img src={bug1Picture1} alt="Bug ticket created in Jira for Kickstarter"></img>
            </Grid>
            <Grid item xs={2} sm={4} md={4} className="gridContainer">
